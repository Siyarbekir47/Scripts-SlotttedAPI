...
cheat.register_module({
    ...
    spell_w = function()
        ...
        if((features.orbwalker:get_mode() == 1) and (g_local.attack_range+150 > target:dist_to_local()) and (combo_w_box:get_value())) then
        ...
        if((features.orbwalker:get_mode() == 4) and (g_local.attack_range > target:dist_to_local()) and (harras_w_box:get_value())) then
            if(name_spell_e == "PickACard") then
                b_blue = true
                g_input:cast_spell(e_spell_slot.w)
                sleep(0.05)
		...
		if g_input:is_key_pressed(69) then
            if ((name_spell_e == "PickACard") ) then
                g_input:cast_spell(e_spell_slot.w)
                sleep(0.05)
                b_gold = true
		...
		if g_input:is_key_pressed(84) then
            if ((name_spell_e == "PickACard") ) then
                g_input:cast_spell(e_spell_slot.w)
                sleep(0.1)
                b_red = true
		...
		if g_input:is_key_pressed(89) then
            if ((name_spell_e == "PickACard") ) then
                g_input:cast_spell(e_spell_slot.w)
                sleep(0.05)
                b_blue = true
        ...
        if (b_red == true and name_spell_e == "RedCardLock") then
            g_input:cast_spell(e_spell_slot.w)
            g_input:cast_spell(e_spell_slot.w)
            g_input:cast_spell(e_spell_slot.w)
            g_input:cast_spell(e_spell_slot.w)
        ...
        if (b_blue == true and name_spell_e == "BlueCardLock") then
            g_input:cast_spell(e_spell_slot.w)
            g_input:cast_spell(e_spell_slot.w)
            g_input:cast_spell(e_spell_slot.w)
            g_input:cast_spell(e_spell_slot.w)
        ...
        -- getting Spellname and setting boolean back to false
        if (b_gold == true and name_spell_e == "GoldCardLock") then
            g_input:cast_spell(e_spell_slot.w)
            g_input:cast_spell(e_spell_slot.w)
            g_input:cast_spell(e_spell_slot.w)
            g_input:cast_spell(e_spell_slot.w)
